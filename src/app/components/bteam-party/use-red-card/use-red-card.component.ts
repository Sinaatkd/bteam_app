...
@Component({
  selector: 'app-use-red-card',
  templateUrl: './use-red-card.component.html',
  styleUrls: ['./use-red-card.component.scss'],
})
export class UseRedCardComponent implements OnInit {
  ...
  onContinueButtonClicked() {
    ...
    this.bteamPartyService.useGift('red-b', this.selectedGift).subscribe(res => {
